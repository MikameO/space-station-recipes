...
(function () {
  ...
  var T = {
    ...
    'From': 'От',
    'To': 'К',
    'Two-reagent map': 'Карта двух реагентов',
    'Every combination of two reagents that fits the casing, coloured by the metric you pick. The outlined cell is the best one.': 'Все сочетания двух реагентов, влезающие в корпус, окрашенные по выбранной метрике. Обведённая клетка — лучшая.',
    'Across': 'По горизонтали',
    'Up': 'По вертикали',
    'Colour by': 'Цвет по',
    'Load this mix': 'Загрузить смесь',
    'Cheap but strong': 'Дёшево, но мощно',
    'The least scarce material that still reaches a given share of the best result this casing can produce. Click a row to load that mixture.': 'Минимум дефицитного сырья, при котором смесь всё ещё берёт заданную долю от лучшего результата корпуса. Клик по строке загружает смесь.',
