...
- Журнал комнаты скачивается файлом: полная хронология с временем, должностью и игровыми координатами, по строке на действие. Пример строки: `18:05:07  Офицер штаба  запрос mortar 253 -198`.
