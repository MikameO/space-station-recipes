...
Страница «Тактическая карта» на нашем сайте уже считает координаты для миномёта, ОБ и поставки по коду Space Stories. Командный планшет добавляет к ней «комнату» на один раунд: офицеры записывают туда метки, план и запросы удара, которые уже прозвучали по рации. На первом этапе комната рассчитана на двоих: офицер штаба выдаёт миномётному расчёту запросы на удар и на позицию, расчёт видит их на карте и отвечает статусами, а офицер видит, где стоит миномёт и куда он достаёт.
