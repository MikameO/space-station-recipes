...
| stories_cm | Space Stories — Marine Corps Core | RU | 128 | discord.gg/PUqaMx7ryn (hub) · discord.gg/space-stories-mc (README) | spacestories.club/Marine_Corps · forum.spacestories.club | MetalSage/space-stories-cm14 | 18 / 12 (TC поверх RMC14) | — | — | **RU-1 (с ОТ)** | текст готов — [stories-guide.md](stories-guide.md): обращение к модераторам + гайд в 3 сообщениях (химия + таб «Взрывное дело» для оружейных техников); единственный форк с Ordnance |
