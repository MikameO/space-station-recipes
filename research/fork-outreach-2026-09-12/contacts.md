...
| stories_cm | Space Stories — Marine Corps Core | RU | 128 | discord.gg/PUqaMx7ryn (hub) · discord.gg/space-stories-mc (README) | spacestories.club/Marine_Corps · forum.spacestories.club | MetalSage/space-stories-cm14 | 18 / 12 (TC поверх RMC14) | — | — | **RU-1 (с ОТ)** | текст готов и сверен с продом 2026-09-13 — [stories-guide.md](stories-guide.md): обращение к модераторам (+ вопрос о тактической карте) и гайд в 3 сообщениях (химия + таб «Взрывное дело»), 4-е про тактическую карту — после контрольного раунда и ответа администрации; единственный форк с Ordnance; первый вопрос из сообщества уже был (ИСКРА К874, английский интерфейс) |
